(function($) {
    ...
    function preloader() {
        if($('.preloader').length) {
            $('.preloader').delay(3000).fadeOut(3000, function() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll(".more").forEach(function (btn) {
            btn.addEventListener("click", function (e) {
                e.preventDefault();
                const details = this.closest(".details").querySelector(".hidden-text");
                if (details.style.display === "none") {
                    details.style.display = "block";
                    this.innerHTML = 'Hide <i class="fa fa-angle-up"></i>';
                } else {
                    details.style.display = "none";
                    this.innerHTML = 'Details <i class="fa fa-angle-right"></i>';
                }
            });
        });
    });
